...
1. Windows server related
   a. Remote desktop: 
		...
		Linux: 2
			...
			I hit several other snags along the way and each was very hard to troubleshoot, config files in etc, sudo-ing, checking logs, but the .profile one was key.<br>Once this was figured out, xrdp works very well - but I wanted the install to be a no-brainer and it hurt my brain.
...
5. Jellyfin
	Windows: 5
		Simple to install and run, nice little toolbar helper icon, however see 1.b NAS mounts, once they flunk then jellyfin is lost. 
	Linux: 5
...
7. Development tools
   ...
   e. podman
		...
		Linux: 5
			just works.
8. Predictability and Repeatability
	Windows: 3
...
## My comparison at the end
Summary is that my windows setup while glitchy in cases scored a 60, and moving to linux did improve it to 61, 
...
| 8 | Predictability and Repeatability (Config) | 3 | 5 | 
| **---** | **---** | **---** | **---** | 
| **TOTAL SCORE** | (Out of 80) | **65** | **66** |